...
#define _CONTROL_NUM 100
    ...
    __attribute__((unused)) static void save_pool(unsigned n, std::vector<Neighbor> &pool)
    {
    ...
    void
    IndexNSG::Link(const Parameters &parameters, SimpleNeighbor *cut_graph_, const unsigned long *traversal_sequence)
    {
        /*
