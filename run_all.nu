...
~/.cargo/bin/rust-tools build-index-async 70 60 500 ./gist_400nn.graph ./gist_base.fvecs ./result-gist-async.json | save -f gist_index_400_async.txt
...
~/.cargo/bin/rust-tools build-index-async 50 40 500 ./sift_200nn.graph ./sift_base.fvecs ./result-sift-async.json | save -f sift_index_200_async.txt
