...
int main(int argc, char **argv) {
  ...
  sjq_static_omp_static::IndexNSG index(dim, points_num, efanna2e::L2, nullptr);
  ...
  for (unsigned traversal_idx = 1; traversal_idx <= 3; traversal_idx++) {
    for (unsigned round = 0; round < 5; round++) {
      ...
      sjq_static_omp_static::distribute_traversal_sequence(traversal_sequence,traversal_sequence_reordered,T,index.nd_,nd_rounded_);
      ...
      index.Build_static(points_num, data_load, paras, traversal_sequence_reordered);
